...
(function () {
  ...
  const STRINGS = {
    fr: {
      ...
      'levier.editorNote': 'Ce texte part du prompt source. Modifiez-le comme vous voulez : ' +
                           'le prompt se met à jour.',
      'levier.editor.heading': 'Niveau de titre',
      'levier.editor.bold': 'Gras',
      'levier.editor.italic': 'Italique',
      'levier.editor.ordered': 'Liste numérotée',
      'levier.editor.bullet': 'Liste à puces',
      'levier.editor.link': 'Lien',
      'levier.editor.code': 'Code',
      'levier.editor.codeBlock': 'Bloc de code',
      'levier.auto': 'Auto',
    ...
    en: {
      ...
      'levier.editorNote': 'This text starts from the source prompt. Edit it however you like — ' +
                           'the prompt updates.',
      'levier.editor.heading': 'Heading level',
      'levier.editor.bold': 'Bold',
      'levier.editor.italic': 'Italic',
      'levier.editor.ordered': 'Numbered list',
      'levier.editor.bullet': 'Bulleted list',
      'levier.editor.link': 'Link',
      'levier.editor.code': 'Code',
      'levier.editor.codeBlock': 'Code block',
      'levier.auto': 'Auto',
